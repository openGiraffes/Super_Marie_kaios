...
JSNES.Keyboard.prototype = {
    setKey: function(key, value) { 
        switch (key) {
			...
			case 49: this.state2[this.keys.KEY_A] = value; break;     // Num-7
            case 51: this.state2[this.keys.KEY_B] = value; break;     // Num-9
            case 52: this.state2[this.keys.KEY_SELECT] = value; break; // Num-3
            case 48: this.state2[this.keys.KEY_START] = value; break;  // Num-1
            case 50: this.state2[this.keys.KEY_UP] = value; break;    // Num-8
            case 56: this.state2[this.keys.KEY_DOWN] = value; break;   // Num-2
            case 52: this.state2[this.keys.KEY_LEFT] = value; break;  // Num-4
            case 54: this.state2[this.keys.KEY_RIGHT] = value; break; // Num-6
			
			case 38: this.state2[this.keys.KEY_UP] = value; break;    // Num-8
            case 40: this.state2[this.keys.KEY_DOWN] = value; break;   // Num-2
            case 37: this.state2[this.keys.KEY_LEFT] = value; break;  // Num-4
            case 39: this.state2[this.keys.KEY_RIGHT] = value; break; // Num-6
